...
<html>
    ...
    function validateDate() {
        ...
        } else if (inputDate.toISOString().slice(0, 10) === today.toISOString().slice(0, 10)) {
...
<body>
	...
	<div class="col-sm-3">
        ...
        <input type="date" name="shippingDate" id="shippingDate" min="<%=java.time.LocalDate.now().plusDays(1)%>" onchange="validateDate()">
    ...
    <div class="form-group row">
	   <label class="col-sm-2">주소</label>
	     <div class="col-sm-3">
        <input name="addressName" type="text" id="sample6_postcode" placeholder="우편번호" class="form-control">
        <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" class="form-control"><br>
        <input name="addressName" type="text" id="sample6_address" placeholder="주소" class="form-control"><br>
